    ...
    <ScrollView style={styles.scrollView}>
      <View style={styles.container}>
          ...
          <View style={{alignItems: 'center', paddingVertical: 20}}>
            ...
            <TouchableOpacity
              ...
              <Text style={{color: colors.primary}}>
                {' '}
                {updatingImage ? 'Cập nhật...' : 'Thêm hình ảnh'}{' '}
              </Text>
            </TouchableOpacity>
          </View>
        )}
        ...
        <View style={styles.topCallOptions}>
          <TouchableOpacity
            style={styles.topCallOption}
            onPress={() => {
              Alert.alert('', 'Tính năng đang trong quá trình phát triển', [
                {
                  text: 'Xác nhận',
                  onPress: () => {},
                },
            ...
            <Icon
              ...
              size={27}
            />
            <Text style={styles.middleText}>Gọi điện</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.topCallOption}
            onPress={() => {
            ...
            <Icon
              ...
              size={27}
            />
            <Text style={styles.middleText}>Nhắn tin</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.topCallOption}
            onPress={() => {
            ...
            <Icon
              ...
              size={27}
            />
            <Text style={styles.middleText}>Gọi video</Text>
          </TouchableOpacity>
        </View>
